...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.4]{figs/battle1.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.4]{figs/battle1-ammo.png}
...
Pode-se argumentar que não ter munição na linha de frente é uma falha do modelo, mas nesse ponto pode-se considerar que a munição presente na linha de frente não é suficiente para causar dano no inimigo, tornando a modelagem válida.
